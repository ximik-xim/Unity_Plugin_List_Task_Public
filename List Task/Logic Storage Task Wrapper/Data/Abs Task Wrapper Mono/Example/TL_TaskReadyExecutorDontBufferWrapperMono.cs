...
///
/// В этой реализации НЕ используется буфер. Из за чего кол-во прохода по одному и тому же списку увеличено.
/// Как итог лучше НЕ ИСПОЛЬЗОВАТЬ, если большое кол-во элементов
/// </summary>

public class TL_TaskReadyExecutorDontBufferWrapperMono : TL_TaskWrapperMono
{
    [SerializeField] 
    private TL_TaskReadyExecutorDontBuffer _taskExecutor;
