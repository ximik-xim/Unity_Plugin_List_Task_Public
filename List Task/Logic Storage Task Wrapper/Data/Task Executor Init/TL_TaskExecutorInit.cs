...
/// <summary>
/// Родительский класс для определения того как выполнять список задач
/// содержит в себе список задач и логику иниц.
/// </summary>
[System.Serializable]
public class TL_TaskExecutorInit 
{
    [SerializeField]
    public List<LT_AbsTaskWrapperDefault> _listAction;
    ...
    {
        List<LT_AbsTaskWrapperDefault> _buffer = new List<LT_AbsTaskWrapperDefault>();
        bool _isStart = false;
